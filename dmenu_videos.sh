...
main_select_two_electric_boogaloo (){
  ...
  folders=$(ls -d ${drive}/* | dmenu -p "Select Folder" -l 10 -nb '#000000' -nf '#bcb1a3' -sb '#1c3b56' -sf '#bcb1a3' -fn 'UbuntuMono Nerd Font Mono:bold:pixelsize=16')
  if [[ $folders != '' ]]
  then
    ...
    choice=$(ls -d ${folders}/* | dmenu -l 10 -nb '#000000' -nf '#bcb1a3' -sb '#1c3b56' -sf '#bcb1a3' -fn 'UbuntuMono Nerd Font Mono:bold:pixelsize=16')
    if [[ $choice != '' ]]
    then
      path=$(ls -d ${choice}/* | dmenu -p "🎥 What Video?" -i -l 15 -nb '#000000' -nf '#bcb1a3' -sb '#1c3b56' -sf '#bcb1a3' -fn 'UbuntuMono Nerd Font Mono:bold:pixelsize=16')
      if [[ $path != '' ]]
      then 
